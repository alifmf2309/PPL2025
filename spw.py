...
player_ship = 'assets/game/plyship.png'
enemy_ship = 'assets/game/enemyship.png'
ufo_ship = 'assets/game/ufo.png'
player_bullet = 'assets/game/pbullet.png'
enemy_bullet = 'assets/game/enemybullet.png'
ufo_bullet = 'assets/game/enemybullet.png'


''' SOUND '''

laser_sound = pygame.mixer.Sound('assets/sfx/laser.wav')
explosion_sound = pygame.mixer.Sound('assets/sfx/low_expl.wav')
go_sound = pygame.mixer.Sound('assets/sfx/go.wav')
game_over_sound = pygame.mixer.Sound('assets/sfx/game_over.wav')
start_screen_music = pygame.mixer.Sound('assets/sfx/cyberfunk.mp3')
game_over_music = pygame.mixer.Sound('assets/sfx/illusoryrealm.mp3')

background_music = pygame.mixer.music.load('assets/sfx/epicsong.mp3')

pygame.mixer.init()

pygame.display.set_caption("SPACE WAR")

icon = pygame.image.load('assets/game/plyship.png')  # Path ke gambar logo
...
class Explosion(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		self.img_list = []
		for i in range(1, 6):
			img = pygame.image.load(f'assets/game/exp{i}.png').convert()
...
class Game:
	...
	def start_text(self):
		font = pygame.font.SysFont('assets/font/SwipeRaceDemo.ttf', 80)
		text = font.render('SPACE WAR', True, 'blue')
		text_rect = text.get_rect(center=(s_width/2, s_height/2))
		screen.blit(text, text_rect)

		font2 = pygame.font.SysFont('Calibri', 20)
		text2 = font2.render('UAS Pemrograman Python Lanjut', True, 'white')
		text2_rect = text2.get_rect(center=(s_width/2, s_height/2+60))
		screen.blit(text2, text2_rect)

		font3 = pygame.font.SysFont('Calibri', 20)
		text3 = font3.render('|   MUNIF ARYAPUTRA   |   MUHAMMAD HIDAYATULLAH IPANGO   |   ALIF MIFTAKHUL FIRDAUS   |', True, 'white')
		text3_rect = text3.get_rect(center=(s_width/2, s_height/2+90))
		screen.blit(text3, text3_rect)

		font4 = pygame.font.SysFont('Calibri', 20)
		text4 = font4.render('|   22.83.0787   |   22.83.0820   |   22.83.0816   |', True, 'white')
		text4_rect = text4.get_rect(center=(s_width/2, s_height/2+110))
